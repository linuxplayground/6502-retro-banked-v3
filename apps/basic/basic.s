...
;              changed INPUT to throw "break in line ##" on empty line input; 2.22p3    fixed RAM above code / Ibuff above EhBASIC patch breaks STR$()
...
; __RAM0_START__
ccflag     = $0300             ; BASIC CTRL-C flag, 00 = enabled, 01 = dis : SYSTEM SPECIFIC VALUE!
...
; __RAM_START__
Ram_base          = $0800    ; start of user RAM (set as needed, should be page aligned)  : SYSTEM SPECIFIC VALUE!
; __IO_START__
...
@oerror:
      jsr primm
      .byte 10,13,"OPEN ERROR ON SAVE",0
      lda sfs_errno
      jsr prbyte
      rts
@cerror:
      jsr primm
      .byte 10,13,"CLOSE ERROR ON SAVE: ",0
      lda sfs_errno
      jsr prbyte
      rts
...
@baddiskerror:
      jsr primm
      .byte 10,13,"BAD DISK ERROR!",0
      clc
      rts
@cerror:
      jsr primm
      .byte 10,13,"CREATE ERROR!",0
      clc
      rts
@oerror:
      jsr primm
      .byte 10,13,"OPEN ERROR!",0
      clc
      rts
...
LAB_vec:
    ...
    .word $C000             ; Exit vector  : SYSTEM SPECIFIC VALUE!
...
LAB_mess:
    .byte  10,13,"6502 EhBASIC ver 2.22p5.9j [C]old/[W]arm ?",0 ; sign on string
LAB_MSZM:
    .byte 10,13,"Memory size ",0
LAB_SMSG:
    .byte " Bytes free",10,13,"Enhanced BASIC 2.22p5.9j",10,13,"https://github.com/jimjag/JJ65c02",0
...
LAB_BMSG: .byte 10,13,"Break",0
LAB_EMSG: .asciiz " Error"
LAB_LMSG: .asciiz " in line "
LAB_RMSG: .byte 10,13,"Ready",10,13,0
LAB_IMSG: .byte " Extra ignored",10,13,0
LAB_REDO: .byte " Redo from start",10,13,0
