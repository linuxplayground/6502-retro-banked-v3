const unsigned char font40 [0x400] = {
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,  //*  - $00 - ALWAYS BLANK    */
0x18,0x3C,0x3C,0x7E,0x7E,0x7E,0x3C,0x3C,  //*  - $01 - snake head up   */
0x3C,0x3C,0x7E,0x7E,0x7E,0x3C,0x3C,0x18,  //*  - $02 - snake head down */
0x00,0x1C,0x7F,0xFF,0xFF,0x7F,0x1C,0x00,  //*  - $03 - snake head left */
0x00,0x38,0xFE,0xFF,0xFF,0xFE,0x38,0x00,  //*  - $04 - snake head right*/
0x04,0x68,0x37,0x7F,0x7F,0x7F,0x7F,0x3E,  //*  - $05 - apple           */
0x00,0x00,0xFF,0xFF,0xFF,0xFF,0x3C,0x3C,  //*  - $06 - top T           */
0x3C,0x3C,0xFF,0xFF,0xFF,0xFF,0x00,0x00,  //*  - $07 - bottom T        */
0x3C,0x3C,0xFC,0xFC,0xFC,0xFC,0x3C,0x3C,  //*  - $08 - right T         */
0x3C,0x3C,0x3F,0x3F,0x3F,0x3F,0x3C,0x3C,  //*  - $09 - left T          */
0x00,0x00,0xFF,0xFF,0xFF,0xFF,0x00,0x00,  //*  - $0a - horizontal      */
0x3C,0x3C,0x3C,0x3C,0x3C,0x3C,0x3C,0x3C,  //*  - $0b - vertical        */
0x7E,0xFF,0xC3,0xDB,0xDB,0xC3,0xFF,0x7E,  //*  - $0c - tetris block    1 CYAN I     */
0x00,0x00,0x3F,0x3F,0x3F,0x3F,0x3C,0x3C,  //*  - $0d - top left cnr    */
0x00,0x00,0xFC,0xFC,0xFC,0xFC,0x3C,0x3C,  //*  - $0e - top right cnr   */
0x3C,0x3C,0x3F,0x3F,0x3F,0x3F,0x00,0x00,  //*  - $0f - bottom left cnr */
0x3C,0x3C,0xFC,0xFC,0xFC,0xFC,0x00,0x00,  //*  - $10 - bottom right cnr*/
0x7E,0xFF,0xC3,0xDB,0xDB,0xC3,0xFF,0x7E,  //*  - $11 - tetris block    2 DARK BLUE J*/
0x7E,0xFF,0xC3,0xDB,0xDB,0xC3,0xFF,0x7E,  //*  - $12 - tetris block    3 ORANGE L   */
0x7E,0xFF,0xC3,0xDB,0xDB,0xC3,0xFF,0x7E,  //*  - $13 - tetris block    4 YELLOW O   */
0x7E,0xFF,0xC3,0xDB,0xDB,0xC3,0xFF,0x7E,  //*  - $14 - tetris block    5 GREEN S    */
0x7E,0xFF,0xC3,0xDB,0xDB,0xC3,0xFF,0x7E,  //*  - $15 - tetris block    6 RED Z      */
0x7E,0xFF,0xC3,0xDB,0xDB,0xC3,0xFF,0x7E,  //*  - $16 - tetris block    7 MAGENTA T  */
